...
const Admin = () => {
  ...
  const handleGenerateSampleOrders = () => {
    ...
    const sampleCustomers = [
      { name: 'Table 1', tableNumber: '1' },
      { name: 'Table 2', tableNumber: '2' },
      { name: 'Table 3', tableNumber: '3' },
      { name: 'Table 4', tableNumber: '4' },
      { name: 'Table 5', tableNumber: '5' },
      { name: 'Table 6', tableNumber: '6' },
      { name: 'Table 7', tableNumber: '7' },
      { name: 'Table 8', tableNumber: '8' },
      { name: 'Table 9', tableNumber: '9' },
      { name: 'Table 10', tableNumber: '10' },
    ];
